package com.lbq.concurrent.juc.automic.section2;
 ...
 * 本节学习了AtomicBooelan的使用方法，通常情况下，我们可以使用AtomicBoolean来进行某个flag的开关控制。
 * 为了加深大家对AtomicBoolean的理解，我们借助于AtomicBoolean实现了一个TryLock，该显式锁旨在提供线程获取锁失败立即返回的解决方案，
